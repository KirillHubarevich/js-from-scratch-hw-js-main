...
NextButton.addEventListener('click', function () {
    if (image.src === WEB_TECH_IMAGES[0]) {
        image.src = WEB_TECH_IMAGES[1];
    } else if (image.src === WEB_TECH_IMAGES[1]) {
        image.src = WEB_TECH_IMAGES[2]
    } else if (image.src === WEB_TECH_IMAGES[2]) {
...
// Должно происходить: клик (next) - изображение [1] - стало [2], клик (next) - [3], клик (next) - стало [1] и по циклу
// И должно происходить: клик (prev) - изображение [1] - стало [3], клик (prev) - [2], клик (prev) - стало [1] и по циклу
